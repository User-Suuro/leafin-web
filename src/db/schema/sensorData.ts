...
import { mysqlTable, serial, varchar, boolean, int, timestamp } from "drizzle-orm/mysql-core";
...
export const sensorData = mysqlTable("sensor_data", {
  ...
  is_water_lvl_normal: varchar("is_water_lvl_normal", { length: 50 }).notNull(),
